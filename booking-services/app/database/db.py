...
async def connect_to_mongo():
    global mongodb_client, parking_database,user_database
    mongodb_client = AsyncIOMotorClient(settings.MONGO_URI)
    user_database = mongodb_client[settings.USER_SERVICES_DB]
    parking_database=mongodb_client[settings.PARKING_SERVICES_DB]
