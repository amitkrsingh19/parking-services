...
services={
    "user":"http://user-services:8000",
    "parking":"http://parking-services:8000",
    "booking":"http://booking-services:8000"
}
...
@app.api_route("/{service_name}/{path:path}",methods=["GET","POST","DELETE","PATCH"] )
